...
- (void)setNaviViewControllers
{
    ...
    WBHomePageVC *tansboundaryVC = [[WBHomePageVC alloc] init];
    self.tansboundaryNav = [[UINavigationController alloc] initWithRootViewController:tansboundaryVC];
...
- (void)setMainTabbar
{
    ...
    self.viewControllers = [NSArray arrayWithObjects:self.tansboundaryNav,self.discoverNav, nil];
