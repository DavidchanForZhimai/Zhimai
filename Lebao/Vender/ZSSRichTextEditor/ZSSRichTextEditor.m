...
- (void)viewDidLoad {
    ...
    // Source View
    CGRect frame = CGRectMake(0, StatusBarHeight + NavigationBarHeight, self.view.frame.size.width, self.view.frame.size.height -( StatusBarHeight + NavigationBarHeight));
...
//            }
//            else {
//                [weakSelf updateImage:[NSString stringWithFormat:@"%@%@",ImageURLS,imageUrl]alt:[NSString stringWithFormat:@"%@%@",ImageURLS,imageUrl]];
//                
//            }
